...
temp_directory = './results/crossdataset_ynoguti_braccent/SVM/128/crossdataset/temp/'
result_directory = './results/crossdataset_ynoguti_braccent/SVM/128/crossdataset/results/'
