...
temp_directory = './results/crossdataset_ynoguti_braccent/iVector/300/temp/'
result_directory = './results/crossdataset_ynoguti_braccent/iVector/300/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_300_crossdataset.py'
...
algorithm = bob.bio.gmm.algorithm.IVector(subspace_dimension_of_t = 300, tv_training_iterations = 10, update_sigma = True, use_whitening = True, use_lda = False, use_wccn = False, use_plda = False, lda_dim = 50, plda_dim_F  = 50, plda_dim_G = 50, plda_training_iterations = 50, number_of_gaussians = 2048)
