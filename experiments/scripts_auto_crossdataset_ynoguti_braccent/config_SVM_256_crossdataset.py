...
temp_directory = './results/crossdataset_ynoguti_braccent/SVM/256/temp/'
result_directory = './results/crossdataset_ynoguti_braccent/SVM/256/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_256_crossdataset.py'
