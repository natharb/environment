...
temp_directory = './results/crossdataset_ynoguti_braccent/SVM/512/temp/'
result_directory = './results/crossdataset_ynoguti_braccent/SVM/512/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_512_crossdataset.py'
