...
temp_directory = './results/crossdataset_ynoguti_braccent/GMM/512/temp/'
result_directory = './results/crossdataset_ynoguti_braccent/GMM/512/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_crossdataset.py'
...
algorithm = bob.bio.gmm.algorithm.GMMRegular(number_of_gaussians = 512, kmeans_training_iterations = 10, gmm_training_iterations = 10,
