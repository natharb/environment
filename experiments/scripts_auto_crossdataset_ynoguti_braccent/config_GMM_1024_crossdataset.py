...
temp_directory = './results/crossdataset_ynoguti_braccent/GMM/1024/temp/'
result_directory = './results/crossdataset_ynoguti_braccent/GMM/1024/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_1024_crossdataset.py'
...
algorithm = bob.bio.gmm.algorithm.GMMRegular(number_of_gaussians = 1024, kmeans_training_iterations = 10, gmm_training_iterations = 10,
