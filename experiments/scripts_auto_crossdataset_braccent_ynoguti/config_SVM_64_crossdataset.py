...
temp_directory = './results/crossdataset_braccent_ynoguti/SVM/64/crossdataset/temp/'
result_directory = './results/crossdataset_braccent_ynoguti/SVM/64/crossdataset/results/'
