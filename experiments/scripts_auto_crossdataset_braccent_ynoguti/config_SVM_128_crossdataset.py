...
temp_directory = './results/crossdataset_braccent_ynoguti/SVM/128/crossdataset/temp/'
result_directory = './results/crossdataset_braccent_ynoguti/SVM/128/crossdataset/results/'
