...
temp_directory = './results/crossdataset_braccent_ynoguti/SVM/2048/temp/'
result_directory = './results/crossdataset_braccent_ynoguti/SVM/2048/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_2048_crossdataset.py'
...
algorithm = bob.bio.gmm.algorithm.SVMGMM(number_of_gaussians = 2048, kmeans_training_iterations = 10, gmm_training_iterations = 10,
