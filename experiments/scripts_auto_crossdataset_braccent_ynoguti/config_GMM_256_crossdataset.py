...
temp_directory = './results/crossdataset_braccent_ynoguti/GMM/256/temp/'
result_directory = './results/crossdataset_braccent_ynoguti/GMM/256/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_crossdataset.py'
