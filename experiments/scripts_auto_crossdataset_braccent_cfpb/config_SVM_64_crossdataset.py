...
temp_directory = './results/crossdataset_braccent_cfpb/SVM/64/crossdataset/temp/'
result_directory = './results/crossdataset_braccent_cfpb/SVM/64/crossdataset/results/'
