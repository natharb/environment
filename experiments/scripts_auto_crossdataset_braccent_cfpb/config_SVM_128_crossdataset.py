...
temp_directory = './results/crossdataset_braccent_cfpb/SVM/128/crossdataset/temp/'
result_directory = './results/crossdataset_braccent_cfpb/SVM/128/crossdataset/results/'
