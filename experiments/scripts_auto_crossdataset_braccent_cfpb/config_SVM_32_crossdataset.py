...
temp_directory = './results/crossdataset_braccent_cfpb/SVM/32/crossdataset/temp/'
result_directory = './results/crossdataset_braccent_cfpb/SVM/32/crossdataset/results/'
