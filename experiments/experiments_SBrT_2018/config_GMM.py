...
temp_directory = './results/closedset_ynoguti/temp/'
result_directory = './results/closedset_ynoguti/results/'
...
algorithm = bob.bio.gmm.algorithm.GMMRegular(number_of_gaussians = 128, kmeans_training_iterations = 10, gmm_training_iterations = 10,
