...
temp_directory = './closedset_ynogutti/ivector/256/T100/fold_10/temp/'
result_directory = './closedset_ynogutti/ivector/256/T100/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_ivector_T100_fold10.py'
...
algorithm = bob.bio.gmm.algorithm.IVector(subspace_dimension_of_t = 100, tv_training_iterations = 10, update_sigma = True, use_whitening = True, use_lda = False, 
