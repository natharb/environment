...
temp_directory = './results/closedset_braccent/SVM/64/fold_2/temp/'
result_directory = './results/closedset_braccent/SVM/64/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_64_fold2.py'
