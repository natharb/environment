...
temp_directory = './results/closedset_braccent/SVM/2048/fold_4/temp/'
result_directory = './results/closedset_braccent/SVM/2048/fold_4/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_2048_fold4.py'
