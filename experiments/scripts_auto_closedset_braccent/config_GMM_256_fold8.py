...
temp_directory = './results/closedset_braccent/GMM/256/fold_8/temp/'
result_directory = './results/closedset_braccent/GMM/256/fold_8/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_fold8.py'
