...
temp_directory = './results/closedset_braccent/GMM/512/fold_2/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold2.py'
