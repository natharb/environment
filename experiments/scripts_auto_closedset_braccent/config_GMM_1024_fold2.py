...
temp_directory = './results/closedset_braccent/GMM/1024/fold_2/temp/'
result_directory = './results/closedset_braccent/GMM/1024/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_1024_fold2.py'
