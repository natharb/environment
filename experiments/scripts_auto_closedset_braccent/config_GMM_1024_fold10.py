...
temp_directory = './results/closedset_braccent/GMM/1024/fold_10/temp/'
result_directory = './results/closedset_braccent/GMM/1024/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_1024_fold10.py'
