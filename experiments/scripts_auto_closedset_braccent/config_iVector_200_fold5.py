...
temp_directory = './results/closedset_braccent/iVector/200/fold_5/temp/'
result_directory = './results/closedset_braccent/iVector/200/fold_5/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_200_fold5.py'
