...
temp_directory = './results/closedset_braccent/GMM/256/fold_9/temp/'
result_directory = './results/closedset_braccent/GMM/256/fold_9/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_fold9.py'
