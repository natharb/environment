...
temp_directory = './results/closedset_braccent/SVM/1024/fold_3/temp/'
result_directory = './results/closedset_braccent/SVM/1024/fold_3/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_1024_fold3.py'
