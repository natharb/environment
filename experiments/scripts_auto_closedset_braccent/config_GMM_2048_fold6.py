...
temp_directory = './results/closedset_braccent/GMM/2048/fold_6/temp/'
result_directory = './results/closedset_braccent/GMM/2048/fold_6/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_2048_fold6.py'
