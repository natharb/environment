...
temp_directory = './results/closedset_braccent/iVector/200/fold_7/temp/'
result_directory = './results/closedset_braccent/iVector/200/fold_7/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_200_fold7.py'
