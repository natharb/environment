...
temp_directory = './results/closedset_braccent/GMM/512/fold_9/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_9/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold9.py'
