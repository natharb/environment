...
temp_directory = './results/closedset_braccent/iVector/300/fold_6/temp/'
result_directory = './results/closedset_braccent/iVector/300/fold_6/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_300_fold6.py'
