...
temp_directory = './results/closedset_braccent/GMM/256/fold_7/temp/'
result_directory = './results/closedset_braccent/GMM/256/fold_7/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_fold7.py'
