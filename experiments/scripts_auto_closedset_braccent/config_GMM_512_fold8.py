...
temp_directory = './results/closedset_braccent/GMM/512/fold_8/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_8/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold8.py'
