...
temp_directory = './results/closedset_braccent/GMM/512/fold_3/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_3/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold3.py'
