...
temp_directory = './results/closedset_braccent/SVM/2048/fold_7/temp/'
result_directory = './results/closedset_braccent/SVM/2048/fold_7/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_2048_fold7.py'
