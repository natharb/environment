...
temp_directory = './results/closedset_braccent/SVM/128/fold_9/temp/'
result_directory = './results/closedset_braccent/SVM/128/fold_9/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_128_fold9.py'
