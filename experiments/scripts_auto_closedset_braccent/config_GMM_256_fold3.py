...
temp_directory = './results/closedset_braccent/GMM/256/fold_3/temp/'
result_directory = './results/closedset_braccent/GMM/256/fold_3/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_fold3.py'
