...
temp_directory = './results/closedset_braccent/SVM/32/fold_2/temp/'
result_directory = './results/closedset_braccent/SVM/32/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_32_fold2.py'
...
algorithm = bob.bio.gmm.algorithm.SVMGMM(number_of_gaussians = 32, kmeans_training_iterations = 10, gmm_training_iterations = 10,
