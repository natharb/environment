...
temp_directory = './results/closedset_braccent/SVM/512/fold_2/temp/'
result_directory = './results/closedset_braccent/SVM/512/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_512_fold2.py'
