...
temp_directory = './results/closedset_braccent/iVector/400/fold_6/temp/'
result_directory = './results/closedset_braccent/iVector/400/fold_6/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_400_fold6.py'
