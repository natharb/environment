...
temp_directory = './results/closedset_braccent/GMM/512/fold_6/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_6/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold6.py'
