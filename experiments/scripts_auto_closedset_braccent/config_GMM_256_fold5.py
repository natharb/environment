...
temp_directory = './results/closedset_braccent/GMM/256/fold_5/temp/'
result_directory = './results/closedset_braccent/GMM/256/fold_5/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_fold5.py'
