...
temp_directory = './results/closedset_braccent/GMM/512/fold_4/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_4/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold4.py'
