...
temp_directory = './results/closedset_braccent/SVM/128/fold_7/temp/'
result_directory = './results/closedset_braccent/SVM/128/fold_7/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_128_fold7.py'
