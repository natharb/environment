...
temp_directory = './results/closedset_braccent/iVector/300/fold_2/temp/'
result_directory = './results/closedset_braccent/iVector/300/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_300_fold2.py'
