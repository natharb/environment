...
temp_directory = './results/closedset_braccent/iVector/200/fold_10/temp/'
result_directory = './results/closedset_braccent/iVector/200/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_200_fold10.py'
