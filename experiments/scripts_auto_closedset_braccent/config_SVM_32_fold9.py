...
temp_directory = './results/closedset_braccent/SVM/32/fold_9/temp/'
result_directory = './results/closedset_braccent/SVM/32/fold_9/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_32_fold9.py'
