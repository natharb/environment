...
temp_directory = './results/closedset_braccent/iVector/400/fold_10/temp/'
result_directory = './results/closedset_braccent/iVector/400/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_400_fold10.py'
