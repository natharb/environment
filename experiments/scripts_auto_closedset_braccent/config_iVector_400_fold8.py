...
temp_directory = './results/closedset_braccent/iVector/400/fold_8/temp/'
result_directory = './results/closedset_braccent/iVector/400/fold_8/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_400_fold8.py'
