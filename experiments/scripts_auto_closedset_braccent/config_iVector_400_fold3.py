...
temp_directory = './results/closedset_braccent/iVector/400/fold_3/temp/'
result_directory = './results/closedset_braccent/iVector/400/fold_3/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_400_fold3.py'
