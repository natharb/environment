...
temp_directory = './results/closedset_braccent/GMM/2048/fold_8/temp/'
result_directory = './results/closedset_braccent/GMM/2048/fold_8/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_2048_fold8.py'
