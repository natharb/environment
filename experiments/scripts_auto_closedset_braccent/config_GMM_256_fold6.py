...
temp_directory = './results/closedset_braccent/GMM/256/fold_6/temp/'
result_directory = './results/closedset_braccent/GMM/256/fold_6/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_fold6.py'
