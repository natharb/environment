...
temp_directory = './results/closedset_braccent/SVM/2048/fold_10/temp/'
result_directory = './results/closedset_braccent/SVM/2048/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_2048_fold10.py'
