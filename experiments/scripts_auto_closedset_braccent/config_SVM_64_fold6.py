...
temp_directory = './results/closedset_braccent/SVM/64/fold_6/temp/'
result_directory = './results/closedset_braccent/SVM/64/fold_6/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_64_fold6.py'
