...
temp_directory = './results/closedset_braccent/iVector/300/fold_9/temp/'
result_directory = './results/closedset_braccent/iVector/300/fold_9/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_300_fold9.py'
