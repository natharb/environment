...
temp_directory = './results/closedset_braccent/SVM/512/fold_3/temp/'
result_directory = './results/closedset_braccent/SVM/512/fold_3/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_512_fold3.py'
