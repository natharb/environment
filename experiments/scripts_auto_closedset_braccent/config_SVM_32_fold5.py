...
temp_directory = './results/closedset_braccent/SVM/32/fold_5/temp/'
result_directory = './results/closedset_braccent/SVM/32/fold_5/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_32_fold5.py'
