...
temp_directory = './results/closedset_braccent/GMM/256/fold_1/temp/'
result_directory = './results/closedset_braccent/GMM/256/fold_1/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_256_fold1.py'
