...
temp_directory = './results/closedset_braccent/SVM/32/fold_10/temp/'
result_directory = './results/closedset_braccent/SVM/32/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_32_fold10.py'
...
algorithm = bob.bio.gmm.algorithm.SVMGMM(number_of_gaussians = 32, kmeans_training_iterations = 10, gmm_training_iterations = 10,training_threshold = 5e-4, variance_threshold = 5e-4, update_weights = True, update_means = True, update_variances = True, relevance_factor = 4, gmm_enroll_iterations = 1, responsibility_threshold = 0, INIT_SEED = 5489)
