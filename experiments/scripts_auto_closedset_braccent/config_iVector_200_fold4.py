...
temp_directory = './results/closedset_braccent/iVector/200/fold_4/temp/'
result_directory = './results/closedset_braccent/iVector/200/fold_4/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_200_fold4.py'
