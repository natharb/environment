...
temp_directory = './results/closedset_braccent/GMM/512/fold_5/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_5/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold5.py'
