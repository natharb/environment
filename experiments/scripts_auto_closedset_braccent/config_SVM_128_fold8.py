...
temp_directory = './results/closedset_braccent/SVM/128/fold_8/temp/'
result_directory = './results/closedset_braccent/SVM/128/fold_8/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_128_fold8.py'
