...
temp_directory = './results/closedset_braccent/GMM/2048/fold_1/temp/'
result_directory = './results/closedset_braccent/GMM/2048/fold_1/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_2048_fold1.py'
