...
temp_directory = './results/closedset_braccent/iVector/300/fold_1/temp/'
result_directory = './results/closedset_braccent/iVector/300/fold_1/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_300_fold1.py'
