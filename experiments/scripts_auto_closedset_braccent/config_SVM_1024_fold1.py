...
temp_directory = './results/closedset_braccent/SVM/1024/fold_1/temp/'
result_directory = './results/closedset_braccent/SVM/1024/fold_1/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_1024_fold1.py'
