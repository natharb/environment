...
temp_directory = './results/closedset_braccent/SVM/2048/fold_5/temp/'
result_directory = './results/closedset_braccent/SVM/2048/fold_5/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_2048_fold5.py'
