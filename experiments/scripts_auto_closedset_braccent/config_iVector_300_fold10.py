...
temp_directory = './results/closedset_braccent/iVector/300/fold_10/temp/'
result_directory = './results/closedset_braccent/iVector/300/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_300_fold10.py'
...
algorithm = bob.bio.gmm.algorithm.IVector(subspace_dimension_of_t = 300, tv_training_iterations = 10, update_sigma = True, use_whitening = True, use_lda = False, use_wccn = False, use_plda = False, lda_dim = 50, plda_dim_F  = 50, plda_dim_G = 50, plda_training_iterations = 50, number_of_gaussians = 256)
