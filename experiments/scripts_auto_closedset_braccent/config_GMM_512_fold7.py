...
temp_directory = './results/closedset_braccent/GMM/512/fold_7/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_7/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold7.py'
