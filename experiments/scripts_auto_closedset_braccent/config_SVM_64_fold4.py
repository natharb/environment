...
temp_directory = './results/closedset_braccent/SVM/64/fold_4/temp/'
result_directory = './results/closedset_braccent/SVM/64/fold_4/results/'
sub_directory = 'subdirectory'

database = 'database_SVM_64_fold4.py'
