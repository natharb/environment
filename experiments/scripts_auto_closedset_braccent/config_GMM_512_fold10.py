...
temp_directory = './results/closedset_braccent/GMM/512/fold_10/temp/'
result_directory = './results/closedset_braccent/GMM/512/fold_10/results/'
sub_directory = 'subdirectory'

database = 'database_GMM_512_fold10.py'
