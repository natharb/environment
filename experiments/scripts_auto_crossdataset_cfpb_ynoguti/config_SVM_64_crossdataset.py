...
temp_directory = './results/crossdataset_cfpb_ynoguti/SVM/64/crossdataset/temp/'
result_directory = './results/crossdataset_cfpb_ynoguti/SVM/64/crossdataset/results/'
