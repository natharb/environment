...
temp_directory = './results/crossdataset_cfpb_ynoguti/SVM/32/crossdataset/temp/'
result_directory = './results/crossdataset_cfpb_ynoguti/SVM/32/crossdataset/results/'
