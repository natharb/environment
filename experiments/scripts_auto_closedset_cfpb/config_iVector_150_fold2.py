...
temp_directory = './results/closedset_cfpb/iVector/150/fold_2/temp/'
result_directory = './results/closedset_cfpb/iVector/150/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_150_fold2.py'
