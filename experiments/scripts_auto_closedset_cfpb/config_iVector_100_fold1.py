...
temp_directory = './results/closedset_cfpb/iVector/100/fold_1/temp/'
result_directory = './results/closedset_cfpb/iVector/100/fold_1/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_100_fold1.py'
