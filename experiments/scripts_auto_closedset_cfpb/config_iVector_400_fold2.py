...
temp_directory = './results/closedset_cfpb/iVector/400/fold_2/temp/'
result_directory = './results/closedset_cfpb/iVector/400/fold_2/results/'
sub_directory = 'subdirectory'

database = 'database_iVector_400_fold2.py'
